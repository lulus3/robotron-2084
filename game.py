...
class Game:
    def __init__(self):
        ...
        self.rainbow_score_text = RainbowText(Config.screen, self.score_text, Config.font, 550, 10, 5)
        self.wave_text = "WAVE  " + str(self.__wave)
        self.rainbow_wave_text = RainbowText(Config.screen, self.wave_text, Config.font, 600, 740, 5)
        self.life_text = "LIVES  " + str(self.__player.get_life())
        self.rainbow_life_text = RainbowText(Config.screen, self.life_text, Config.font, 650, 10, 5)
